// https://material-ui.com/components/menus/#ContextMenu.tsx
...
export default function ContextMenu() {
  ...
  return (
    <div onContextMenu={handleClick} style={{ cursor: 'context-menu' }}>
      ...
      >
        <MenuItem onClick={handleClose}>Open Document</MenuItem>
        <MenuItem onClick={handleClose}>Add To InfoBasket</MenuItem>
        <MenuItem onClick={handleClose}>Remove From InfoBasket</MenuItem>
        <MenuItem onClick={handleClose}>Abstract Information</MenuItem>
      </Menu>
    </div>
  );
}
